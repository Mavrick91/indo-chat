...
export type ChatMessageWithId = Message & { id: string };
...
export function ChatView({
  ...
  const handleSend = useCallback(
      ...
      void (async () => {
        ...
        try {
          ...
          if (!abortController.signal.aborted) {
            ...
            // Persist assistant message before navigating so the DB has it when the route loader fetches
            await addMessage({
              data: {
                conversationId: conversationIdRef.current,
                role: "assistant",
            ...
            // Navigate to /chat/:id after persisting so the component isn't unmounted mid-stream
    ...
    [messages, onConversationCreated, queryClient],
  );
